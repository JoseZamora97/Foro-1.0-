 ...
 * @author europ
 */
public class ventanaGuardarForoSer extends javax.swing.JFrame {

    /**
     * Creates new form ventanaGuardarForoSer
     */
    public ventanaGuardarForoSer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setForeground(new java.awt.Color(255, 216, 216));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!textNombre.getText().equals("")){
            try {
                ventanaPrincipal.foro_.actualizarEnMemoria(textNombre.getText() +".ser");
            } catch (IOException ex) {
                Logger.getLogger(ventanaGuardarForoSer.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaGuardarForoSer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
